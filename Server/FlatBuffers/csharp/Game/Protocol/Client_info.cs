...
public struct Client_info : IFlatbufferObject
{
  ...
  public float Horizontal { get { int o = __p.__offset(14); return o != 0 ? __p.bb.GetFloat(o + __p.bb_pos) : (float)0.0f; } }
...
#if ENABLE_SPAN_T
  public Span<byte> GetNameBytes() { return __p.__vector_as_span(18); }
#else
  ...
  public static void StartClient_info(FlatBufferBuilder builder) { builder.StartObject(10); }
  ...
  public static void AddHorizontal(FlatBufferBuilder builder, float horizontal) { builder.AddFloat(5, horizontal, 0.0f); }
