...
public struct Client_Collection : IFlatbufferObject
{
  ...
  public static VectorOffset CreateDataVectorBlock(FlatBufferBuilder builder, Offset<Client_info>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
